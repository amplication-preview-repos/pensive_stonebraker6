...
import { Profession } from "../../profession/base/Profession";
...
export class UserResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => Profession, {
    nullable: true,
    name: "profession",
  })
  @nestAccessControl.UseRoles({
  ...
  async getProfession(
    ...
    const result = await this.service.getProfession(parent.id);
